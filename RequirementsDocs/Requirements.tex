...
Furthermore, although many of these applications have strong features, none have the entire package of usability and full time-domain reporting.  There is a space for Chomp in this market.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\\
Every Thursday the traffic office guys watch football at the pub and reminice
...
\begin{large}
\textbf{\textit{"I need protien, but I swear my roomates are taking my whey when I'm not looking.  I ought to setup a camera to catch them."}}
\end{large}\\
\textbf{Persona:}
\end{appendices}
\end{document}