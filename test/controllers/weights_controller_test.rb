...
class WeightsControllerTest < ActionController::TestCase
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post :create, weight: { Date: @weight.Date, Units: @weight.Units, Weight: @weight.Weight, user_id: @weight.user_id }
    end
  ...
  test "should update weight" do
    patch :update, id: @weight, weight: { Date: @weight.Date, Units: @weight.Units, Weight: @weight.Weight, user_id: @weight.user_id }
    assert_redirected_to weight_path(assigns(:weight))
  end
