class WeightsController < ApplicationController
  ...
  def show
    ...
    unless session[:user_id] == @weight.user_id
      flash[:danger] = "You don't have access to that weight!"
      redirect_to weights_path(session[:user_id])
      return
    end
  end
  ...
  private
    ...
    def weight_params
      params.require(:weight).permit(:Weight, :Units, :Date, :user_id)
    end
end